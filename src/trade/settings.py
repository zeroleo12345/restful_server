...
# APPEND_SLASH = False    # 是否通过301重定向, 自动添加 tail slash
MIDDLEWARE = [
...
MP_ACCOUNT_EXPIRE_TEMPLATE_ID = settings.get('MP_ACCOUNT_EXPIRE_TEMPLATE_ID')
MP_ORDER_PAID_TEMPLATE_ID = settings.get('MP_ORDER_PAID_TEMPLATE_ID')
...
LYN_PLATFORM_ID = settings.get('LYN_PLATFORM_ID')
#
